...
<div id="contact" className="h-auto bg-gradient-to-bl from-indigo-300 via-cyan-500 to-blue-900">
    {/* <div className="bg-[#032D50]"> */}
    <Slide   direction="up"  cascade damping={0.1} duration={500}>
    <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto  rounded-lg h-dvh">
            <div class="grid h-full lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <ul class="flex mt-12 space-x-4">
                        <li class="bg-[#032d50] hover:bg-[#a91079e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <iframe className="w-full" height={450} src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14010.248254604609!2d77.2295097!3d28.612912!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce2daa9eb4d0b%3A0x717971125923e5d!2sIndia%20Gate!5e0!3m2!1sen!2sin!4v1727854064086!5m2!1sen!2sin"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

                    {/* <div class="space-y-4 max-lg:mt-4">
                        <button type="button" class="px-4 py-2 rounded-lg bg-[#032d50] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">Web design</button>
                    ...
                    {/* <form class="mt-8 space-y-4">
                        ...
                        <button type='button'
                            class="text-white bg-[#032d50] hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
